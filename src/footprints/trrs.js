...
module.exports = {
  ...
  body: p => {
    const standard = `
      ...
      ${'' /* footprint reference */}
      (fp_text reference REF** (at 0 14.2) (layer Dwgs.User) hide (effects (font (size 1 1) (thickness 0.15))))
      (fp_text value TRRS-PJ-320A-dual (at 0 -5.6) (layer F.Fab) hide (effects (font (size 1 1) (thickness 0.15))))
